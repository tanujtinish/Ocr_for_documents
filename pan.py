...
def pan_ocr(path,thresh,rescale,average):
	...
	for wordline in text1:
		xx = wordline.split(' ')
		for w in xx:
			if re.search('(INCOMETAXDEPARWENT @|mcommx|INCOME|TAX|GOW|GOVT|GOVERNMENT|OVERNMENT|VERNMENT|DEPARTMENT|EPARTMENT|PARTMENT|ARTMENT|INDIA|NDIA)', w):
				text1 = list(text1)
